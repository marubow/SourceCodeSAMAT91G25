...
#ifdef CONFIG_SYS_SDRAM_256M_SIZE
...
#define I2C_SDA(bit)	if(bit) at91_set_gpio_output(PIN_SDA, 1);\
	else   at91_set_gpio_output(PIN_SDA, 0)
#define I2C_READ	at91_get_gpio_value(PIN_SDA)
#define I2C_DELAY	udelay(20)


/* EEPROM definitions for Atmel AT24C04BN EEPROM chip */
#define CONFIG_SYS_I2C_EEPROM_ADDR_LEN	1
#define CONFIG_SYS_I2C_EEPROM_ADDR		0x51
#define CONFIG_SYS_I2C_EEPROM_CWID
